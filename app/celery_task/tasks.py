...
from app.interface.commands.get_port_tx_signal_level import PonTxSignal
...
@shared_task(bind=True,autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 5},
             name='olt:get_port_tx_signal_level')
def get_port_tx_signal_level(self, payload: Payload):

    port_tx_signal = controller.get(PonTxSignal(payload))
    return port_tx_signal